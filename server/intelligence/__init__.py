"""intelligence — placeholder package (foundation branch).
...
Owning subsystem doc: 00_CANONICAL_PRD.md §25 (IntelligenceProvider) — disabled by default, not implemented
"""
